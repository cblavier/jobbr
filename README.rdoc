...
Delayed jobs can either be running with delayed_job_mongoid or sidekiq.
...
Add delayed_job_mongoid or sidekiq + sidekiq-delay to your Gemfile, and according backend will be used.
